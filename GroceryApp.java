...
class GroceryItem {
    ...
    public GroceryItem(int groceryId, String groceryName, int quantity, int price) {
...
class GroceryApp {
    ...
    public static void main(String[] args) {
        ...
        // Adding sample data
        User user1 = new User(1, name, email, pass,role);
        User user2 = new User(2, "Admin", "admin@example.com", "admin123", "admin");
        portal.addUser(user1);
        portal.addUser(user2);

        GroceryItem item1 = new GroceryItem(1, "Apple", 5, 3);
        GroceryItem item2 = new GroceryItem(2, "Banana", 10, 2);
        portal.addGroceryItem(item1);
        portal.addGroceryItem(item2);

        // Simulating login for a customer
        User loggedInUser = portal.validateLogin(email, pass, portal.users);
